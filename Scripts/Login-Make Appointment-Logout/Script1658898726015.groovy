...
WebUI.setText(findTestObject('Page_Login/txt_UserName'), Username_false)

WebUI.delay(1)

WebUI.setText(findTestObject('Page_Login/txt_Password'), Password_false)


WebUI.click(findTestObject('Page_Login/btn_Login'))


if (WebUI.getText(findTestObject('Page_CURA Healthcare Service/p_Login failed Please ensure the username and password are valid'))==true) {
